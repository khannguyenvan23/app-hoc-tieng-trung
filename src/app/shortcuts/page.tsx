...
function ShortcutTable({ shortcuts }: { shortcuts: Shortcut[] }) {
  return (
    <div className="divide-y divide-zinc-200 border-y border-zinc-200 dark:border-white/10">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            {shortcut.keys.map((key, index) => (
              <span className="contents" key={key}>
                ...
                <kbd className="min-w-8 rounded border border-zinc-300 dark:border-white/15 bg-white dark:bg-[#171a19] px-2 py-1 text-center font-mono text-xs font-semibold text-zinc-800 dark:text-zinc-100 shadow-sm">
                  {key}
                </kbd>
              </span>
            ))}
      ...
      <AppShell>
        <div className="mx-auto max-w-2xl">
          <div className="flex items-start justify-between gap-4">
            ...
            <Link
              className="shrink-0 rounded-md border border-zinc-300 dark:border-white/15 px-3 py-2 text-sm font-medium hover:bg-zinc-100 dark:hover:bg-white/10"
          ...
          <div className="mt-8 rounded-md border border-amber-200 dark:border-amber-500/40 bg-amber-50 dark:bg-amber-500/15 px-4 py-3 text-sm leading-6 text-amber-900 dark:text-amber-200">
